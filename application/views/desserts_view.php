...
<title>Desserts :: McDonalds</title>
...
<body class="page genericpage " style="background:#FFFFFF; background-image: url('images/1336914274329.jpg'); background-repeat: no-repeat; background-position:center top;">
            ...
            <div id="breadcrumb">
                <div class="mcdonaldsbreadcrumb breadcrumb">
		        	<div class="breadCrumb"> 
						<a href='<?php echo base_url()?>home'>Menu</a>&nbsp;<span class='bd_separator'>/</span>&nbsp;<a href='<?php echo base_url()?>desserts' class='last'>Desserts</a>      
		        	</div>      
		       </div>
    ...
    <div id="everythingcontainer" style="padding:140px 0px 0px 25px;margin:0px 0px 10px 0px" >
            ...
            <table class="everythingtable" cellspacing="0" cellpadding="0"> 
              <tr>
                ...
                <img title="Love every morning." style="padding:0px 0px 0px 0px " alt="Love every morning." width="590.0" class="cq-dd-image" src="images/tagline_desserts-shakes.png"></a><br>
                    </div>
                    </div></td>
...
vertical-align:top;
	...
	<p style="width:400px;">rop by for a delectable dessert or a simple boost of sweetness. Choose from our delicious McFlurry®, sundaes, cones, cool Triple Thick Milkshakes, tasty, baked pies and much more..</p>
	<table>
		<!-- row 1 -->
		<tr>
			<?php 
